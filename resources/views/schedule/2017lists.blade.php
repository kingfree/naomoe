@section('lists')
    <table class="ui very basic collapsing celled table">
        ...
        <tr>
            <td>3月6日（月）</td>
            <td>{!! complink('2017-03-06', '表演赛II') !!}</td>
            <td></td>
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            <td>3月7日（火）</td>
            <td>{!! complink('2017-03-07', '八进四东南组') !!}</td>
            <td>2进1选1。东、南2组同时进行</td>
        </tr>
        <tr>
            <td>3月8日（水）</td>
            <td>{!! complink('2017-03-08', '八进四西北组') !!}</td>
            <td>2进1选1。西、北2组同时进行</td>
        </tr>
        <tr>
            <td>3月9日（木）</td>
            <td>{!! complink('2017-03-09', '半决赛') !!}</td>
            <td>2进1选1。东西、南北2组同时进行</td>
        </tr>
        <tr>
            <td>3月10日（金）</td>
            <td>{!! complink('2017-03-10', '三位战') !!}</td>
            <td>决出第三名和第四名</td>
        </tr>
        <tr>
            <td>3月11日（土）</td>
            <td>{!! complink('2017-03-11', '萌王战') !!}</td>
            <td>决出萌王和准萌</td>
        </tr>
        <tr>
            <td>3月12日（日）</td>
