@section('schedule')
    ...
    <style>
        ...
        table.hon tr.green th {
            background-color: #b6e974;
        }

        table.hon tr.orange th {
            background-color: #ffc966;
        }

        table.hon tr.purple th {
            background-color: #dea3ff;
        }

        table.hon tr.yellow th {
    ...
    <table class="hon">
        ...
        <tr>
            <td class="gum">A-1</td>
            <td class="chara">中川花音@只有神知道的世界</td>
            <td class="i"></td>
            <td rowspan="2" class="id">{!! complink('2017-02-28', '2月28日') !!}</td>
        ...
        <tr>
            <td class="gum">B-2</td>
            <td class="chara">雾岛@舰队Collection</td>
            <td class="i"></td>
        </tr>
        <tr>
            <td class="gum">B-3</td>
            ...
            <td class="i"></td>
            <td rowspan="2" class="id">{!! complink('2017-03-04', '3月2日') !!}</td>
            <td rowspan="2" class="ni"></td>
        </tr>
        <tr>
            <td class="gum">B-4</td>
        ...
        <tr>
            <td class="gum">C-1</td>
            <td class="chara">由比滨结衣@我的青春恋爱物语果然有问题。</td>
            <td class="i"></td>
            <td rowspan="2" class="id">{!! complink('2017-02-28', '2月28日') !!}</td>
            <td rowspan="2" class="ni"></td>
            <td rowspan="4" class="nid">{!! complink('2017-03-04', '3月4日') !!}</td>
        ...
        <tr>
            <td class="gum">D-2</td>
            <td class="chara">金刚@舰队Collection</td>
            <td class="i"></td>
        </tr>
        <tr>
            <td class="gum">D-3</td>
        ...
        <tr>
            ...
            <td class="i"></td>
            <td rowspan="2" class="id">{!! complink('2017-03-04', '3月1日') !!}</td>
            <td rowspan="2" class="ni"></td>
            <td rowspan="4" class="nid">{!! complink('2017-03-04', '3月5日') !!}</td>
        </tr>
        <tr>
            <td class="gum">E-2</td>
        ...
        <tr>
            ...
            <td class="i"></td>
            <td rowspan="2" class="id">{!! complink('2017-03-04', '3月3日') !!}</td>
            <td rowspan="2" class="ni"></td>
        </tr>
        <tr>
            <td class="gum">E-4</td>
