@section('schedule')
    ...
    <table class="hon">
        ...
        <tr>
            ...
            <td class="i"></td>
            <td rowspan="2" class="id">2月28日</td>
            <td rowspan="2" class="ni"></td>
            <td rowspan="5" class="nid">3月4日</td>
        </tr>
        <tr>
            <td class="gum">A-2</td>
        ...
        <tr>
            ...
            <td rowspan="2" class="id">2月28日</td>
            <td rowspan="2" class="ni"></td>
            <td rowspan="4" class="nid">3月4日</td>
        </tr>
        <tr>
            <td class="gum">B-2</td>
        ...
        <tr>
            ...
            <td class="i"></td>
            <td rowspan="2" class="id">3月1日</td>
            <td rowspan="2" class="ni"></td>
            <td rowspan="4" class="nid">3月5日</td>
        </tr>
        <tr>
            <td class="gum">E-2</td>
