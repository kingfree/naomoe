                ...
                <div class="ui piled segment">
                    ...
                    <table class="ui very basic collapsing celled table">
                        ...
                        <tr>
                            <td>2月27日（月）</td>
                            <td>00:00~23:00</td>
                            <td>{!! complink('2017-02-27', '二次预选') !!}</td>
                            <td>一次预选中落选角色凡票数大于临组最低票数晋级的，
                                参与二次预选。每人最多投20票，票数最多的前16位
                                晋级本战。</td>
                        </tr>
                        <tr>
                            <td></td>
